...
describe("createDirectoryObject", function () {
	...
	describe("file", function () {
		it("should resolve with no children", function (done) {
			var statStub = sinon.stub().returns(
				Q.resolve({
					isFile: function () {
						return true;
					},
	...
	describe("directory", function () {
		it("should resolve with children", function (done) {
			var path = "./fakeDir";
			var files = ["fakeFile1", "fakeFile2", "fakeFile3"];
		...
		it("should produce a tree across multiple levels", function (done) {
			var path = "fakeDir";
			var files1 = ["fakeDir", "fakeDir", "fakeFile", "fakeFile"];
			var files2 = ["fakeDir", "fakeFile"];
			var files3 = ["fakeFile", "fakeFile"];
	...
	describe("options", function () {
		var path = "./fakeDir";
		var files = ["fakeFile", "fakeDir", "fakeFile", "fakeDir"];
		var options;
		var statStub;
		var readdirStub;
